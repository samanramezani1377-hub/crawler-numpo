...
import("context";"os";"path/filepath";"testing";"time";"github.com/jackc/pgx/v5/pgxpool";"github.com/google/uuid";"github.com/samanramezani1377-hub/crawler-numpo/internal/migrate";"github.com/samanramezani1377-hub/crawler-numpo/internal/store")
...
func TestPostgresPersistence(t *testing.T){
 ...
 s:=&store.Store{DB:db};project:="integration-"+uuid.NewString();job:=uuid.NewString()
 ...
 if e=s.UpsertCandidate(ctx,uuid.NewString(),job,"https://example.com","https://example.com/","example.com","example.com","manual_seed","",100,1);e!=nil{t.Fatal(e)}
